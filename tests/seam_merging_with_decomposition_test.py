...
class SeamMergingWithDecompositionTest(unittest.TestCase):
  def test_applySeamMerging(self):
    p = scipy.io.loadmat(local_path('../tests/mats/applySeamMerging.mat'))
    I = p['I'].T[0] - 1
  ...
  def test_calculatePot(self):
    p = scipy.io.loadmat(local_path('../tests/mats/calculatePot.mat'))
  ...
  def test_dynamic_programming(self):
    p = scipy.io.loadmat(local_path('../tests/mats/dynamic_programming.mat'))
  ...
  def test_generateEastEnergy(self):
    p = scipy.io.loadmat(local_path('../tests/mats/generateEastConnections.mat'))
  ...
  def test_generateEnergyUpLeftRight(self):
    p = scipy.io.loadmat(local_path('../tests/mats/generateEnergyUpLeftRight.mat'))
  ...
  def test_generateNorthEnergy(self):
    p = scipy.io.loadmat(local_path('../tests/mats/generateNorthConnections.mat'))
  ...
  def test_generateSouthEnergy(self):
    p = scipy.io.loadmat(local_path('../tests/mats/generateSouthConnections.mat'))
  ...
  def test_generateWestEnergy(self):
    p = scipy.io.loadmat(local_path('../tests/mats/generateWestConnections.mat'))
  ...
  def test_initializeParameters(self):
    p = scipy.io.loadmat(local_path('../tests/mats/initializeParameters.mat'))
  ...
  def test_sumShifted(self):
    p = scipy.io.loadmat(local_path('../tests/mats/sumShifted.mat'))
